...
VALUES  
    ...
    ('Jack', 'London', 'jlondon@ualasks.edu'),
    ...
    ('Heathcoate', 'Williams', 'hwilliams@bafta.com'),
    ('Sandy', 'Powerll', 'spowell@oscars.com'),
    ...
    ('Monica', 'Bellucci', 'mbell@irreverisble.com'),
